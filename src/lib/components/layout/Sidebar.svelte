<script lang="ts">
	...
	import { Drawer, LightSwitch, toastStore, type ToastSettings } from "@skeletonlabs/skeleton";
...
<Drawer class="md:hidden">
    <div class="h-16 px-4 flex justify-between items-center border-b-2">
    ...
    <div class="p-4 h-[calc(100vh-4rem)] flex flex-col justify-between items-end">
        <nav class="text-xl flex flex-col items-end gap-4">
            {#if loggedIn}
                <a href="/blog">Blog</a>
